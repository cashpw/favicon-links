:PROPERTIES:
:LAST_MODIFIED: [2025-12-11 Thu 16:39]
:END:
#+title: Favicon links

An alternative to [[github:cashpw/dynamic-favicon-links][cashpw/dynamic-favicon-links]] which doesn't need to pull favicons on the fly.
